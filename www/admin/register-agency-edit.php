...
//
//if ($agencyForm->validate_no_auth()) {
...
//
//    // Go to next page
//    OX_Admin_Redirect::redirect("register-agency-user-start.php?agencyid={$aFields['agencyid']}");
//}
//
//
///*-------------------------------------------------------*/
...
//        phpAds_PageHeader_No_Auth("agency-edit_new");
//    }
//
//
